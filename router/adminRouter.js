 ...
 *         description: Internal server error.
 */
router.get('/venues', authorize, getAllListed)
 ...
 * /listed-venues:
 *   get:
 *     summary: Retrieve all listed venues
 *     description: Fetch all venues from the database (only accessible to authorized users).
 *     tags:
 *       - Admin
 *     security:
 ...
 *     responses:
 *       200:
 *         description: All venues successfully retrieved.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                       venuename:
 *                         type: string
 *                         example: Grand Palace Hall
 *                       description:
 *                         type: string
 *                         example: A large indoor hall suitable for weddings and corporate events.
 *                       price:
 *                         type: number
 *                         example: 250000
 *                       type:
 ...
 *                         items:
 *                           type: string
 *                         example: ["Air Conditioning", "Parking Space", "Restrooms"]
 *                       capacity:
 *                         type: object
 *                         properties:
 *                           minimum:
 ...
 *                                 url:
 *                                   type: string
 *                                   example: https://res.cloudinary.com/eventiq/image/upload/cac.pdf
 *                           doc:
 *                             type: array
 *                             items:
 *                               type: object
 ...
 *                                 url:
 *                                   type: string
 *                                   example: https://res.cloudinary.com/eventiq/image/upload/document.pdf
 *       401:
 *         description: Unauthorized access — missing or invalid token.
 *       500:
 *         description: Server error.
 */
router.get('/listed-venues', authorize, allVenues)
